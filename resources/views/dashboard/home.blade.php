<x-dashboard.layout title="Inicio / Dashboard">
    <x-slot:css>
        <link
            rel="stylesheet"
                    ...
                    <div class="relative flex flex-col min-w-0 break-words w-full mb-6 shadow-lg rounded bg-blueGray-700">
                        ...
                        <div class="p-4 flex-auto">
                            ...
                            <div class="relative h-350-px">
                                ...
                                <canvas id="line-chart" style="display: block; width: 607px; height: 350px;" width="607" height="350" class="chartjs-render-monitor"></canvas>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div
                        ...
                        <div class="p-4 flex-auto">
                            ...
                            <div class="relative h-350-px">
                                ...
                                <canvas id="bar-chart" style="display: block; width: 271px; height: 350px;"
                                        width="271" height="350" class="chartjs-render-monitor"></canvas>
                            </div>
                        </div>
                    </div>
                </div>
